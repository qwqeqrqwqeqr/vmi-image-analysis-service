...
def whiten_image(image, output_path):
  ...
  x_start, x_end, y_start, y_end = calculateCropPoints(image, lines)
  ...
  cv2.imwrite(ANSWER_IMAGE_DIRECTORY + "/" + output_path, preprocessing)
